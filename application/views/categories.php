...
$page_header = '
	...
	<script type="text/javascript" src="'.base_url('static/categories.js').'"></script>
';


$page_title = 'Daftar Kategori Kontak';
...
?>
				...
				<div id="content">
					...
					<div class="dialog">
						<p>Dibawah adalah daftar kategori kontak anda</p>
					</div>
					<div id="categories-grid" style="width:100%; height:100%; margin-top:20px;"></div>
