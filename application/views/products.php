...
$page_header = '
    ...
    <script type="text/javascript" src="'.base_url('static/products.js').'"></script>
';


$page_title = 'Product Pelanggan';
...
?>
            <div id="content">
                ...
                <div id="product-grid" style="width:100%; height:100%; margin-top:20px;"></div>
