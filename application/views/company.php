...
$page_header = '
    ...
    <script type="text/javascript" src="'.base_url('static/company.js').'"></script>
';
...
?>
                ...
                <div id="content">
                    ...
                    <div class="dialog">
                        <p>Silahkan edit profil usaha anda disini</p>
                    </div>

                    <div id="company-grid" style="margin:auto; width:95%; height:100%; margin-top:20px;"></div>
