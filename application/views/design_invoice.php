...
?>
                ...
                <div id="content">
                    ...
                    <div class="dialog">
                        <p>Berikut adalah desain template untuk Invoice. <a href="<?php echo site_url('invoices/create'); ?>">Buat template baru</a></p>
                    </div>
                    ...
                    <div id="mydesign" class="itemlist">
                        ...
                        <div class="template-item">
                            <a href="<?php echo site_url('invoices/create?id='.urlencode($template->template_id)); ?>">
