...
?>
		...
		<div id="content">
					...
					<div class="dialog">
						...
						<div class="actionarea">
							<ul>
								...
								<li><a href="<?php echo site_url('customers/upload/'); ?>">Upload informasi Pelanggan</a></li>
								
								<li><a href="<?php echo site_url('customers/'); ?>">Tambah data Pelanggan</a></li>
							</ul>
						</div>
					</div>
					...
					<?php
						...
						echo '<li><div class="msgbox info">Anda mempunyai total <a href="'.site_url('customers').'">'.$customer_count.' pelanggan</a></div></li>';
					
						
					
						$query = $this->db->query("SELECT COUNT(*) AS cnt FROM vouchers WHERE client_id = ? AND (use_date IS NULL OR use_date = '0000-00-00 00:00:00')", array($this->orca_auth->user->client_id));
						$r = $query->row();
						$voucher_count = $r->cnt;
						if ($voucher_count > 0)
							echo '<li><div class="msgbox info">Ada <a href="'.site_url('vouchers').'">'.$voucher_count.' voucher</a> yang belum terproses</div></li>';
