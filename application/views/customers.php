...
$page_header = '
	...
	<script type="text/javascript" src="'.base_url('static/customers.js').'"></script>
';


$page_title = 'Data Kontak';
...
?>
				...
				<div id="content">
					...
					<div class="dialog">
						<p>Dibawah adalah daftar kontak anda</p>
					</div>

					<div id="customer-grid" style="width:100%; height:100%; margin-top:20px;"></div>
