...
$page_header = '
    ...
    <script type="text/javascript" src="'.base_url('static/validate.js').'"></script>
';


$page_title = 'Validasi Voucher';
...
?>
                ...
                <div id="content">
                    ...
                    <div class="dialog">
                        <p>Masukkan kode voucher dibawah untuk divalidasi</p>
                    </div>

                    <div id="validate-grid" style="margin:auto; width:95%; height:100%; margin-top:20px;"></div>
