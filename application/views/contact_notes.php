...
$page_header = '
	...
	<script type="text/javascript" src="'.base_url('static/notes.js').'"></script>
';


$page_title = 'Catatan Kontak';
...
?>
				...
				<div id="content">
					...
					<div id="notes-grid" style="width:100%; height:100%; margin-top:20px;"></div>
