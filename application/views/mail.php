...
<script type="text/javascript" src="'.base_url('static/mail.js').'"></script>
';       
...
?>
                ...
                <div id="content">
                    ...
                    <div class="dialog">
                        <p>Silahkan jadwalkan pengiriman voucher dan campaign anda disini. Berikut isi dari e-mail anda.</p>
                    </div>
                    
                    <div id="mail-grid" style="width:100%; height:100%; margin-top:20px;"></div>
                </div>
		<div id="sidebar">
                    <!-- menu admin -->
