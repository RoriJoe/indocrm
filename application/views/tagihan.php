...
$page_header = '
    ...
    <script type="text/javascript" src="'.base_url('static/tagihan_client.js').'"></script>
';
$page_title = 'Tagihan Client';
...
?>
                ...
                <div id="content">
                    ...
                    <div id="tagihan-grid" style="width:100%; height:100%; margin-top:20px;"></div>
