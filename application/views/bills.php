...
$page_header = '
    ...
    <script type="text/javascript" src="'.base_url('static/bills.js').'"></script>
';


$page_title = 'Informasi Tagihan';
...
?>
                ...
                <div id="content">
                    ...
                    <div class="dialog">
                        <p>Berikut adalah informasi tagihan untuk akun IndoCRM anda.</p>
                    </div>

                    <div id="bills-grid" style="width:100%; height:100%; margin-top:20px;"></div>
